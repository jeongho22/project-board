...
import jeong.boardproject.config.SecurityConfig;
import jeong.boardproject.config.TestSecurityConfig;
import jeong.boardproject.domain.constant.FormStatus;
import jeong.boardproject.domain.constant.SearchType;
import jeong.boardproject.dto.ArticleDto;
import jeong.boardproject.dto.ArticleWithCommentsDto;
import jeong.boardproject.dto.UserAccountDto;
import jeong.boardproject.dto.request.ArticleRequest;
import jeong.boardproject.dto.response.ArticleResponse;
import jeong.boardproject.service.ArticleService;
import jeong.boardproject.service.PaginationService;
import jeong.boardproject.util.FormDataEncoder;
...
class ArticleControllerTest {
    ...
    @WithUserDetails(value = "unoTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)  //실제 유저 디테일을 사용할수있음 testconfig
